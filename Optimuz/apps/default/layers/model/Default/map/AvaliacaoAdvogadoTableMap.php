...
/**
 * This class defines the structure of the 'avaliacao_advogado' table.
 *
 *
 *
 ...
 */
class AvaliacaoAdvogadoTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'Default.map.AvaliacaoAdvogadoTableMap';
	...
	{
		// attributes
		$this->setName('avaliacao_advogado');
		$this->setPhpName('AvaliacaoAdvogado');
		$this->setClassname('AvaliacaoAdvogado');
