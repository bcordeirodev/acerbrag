...
/**
 * This class defines the structure of the 'curtida_forum' table.
 *
 *
 *
 ...
 */
class CurtidaForumTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'Default.map.CurtidaForumTableMap';
	...
	{
		// attributes
		$this->setName('curtida_forum');
		$this->setPhpName('CurtidaForum');
		$this->setClassname('CurtidaForum');
