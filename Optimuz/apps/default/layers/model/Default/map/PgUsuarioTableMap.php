...
/**
 * This class defines the structure of the 'pg_usuario' table.
 *
 *
 *
 ...
 */
class PgUsuarioTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'Default.map.PgUsuarioTableMap';
	...
	{
		// attributes
		$this->setName('pg_usuario');
		$this->setPhpName('PgUsuario');
		$this->setClassname('PgUsuario');
