...
/**
 * Base class that represents a row from the 'advogado' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseAdvogado extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'AdvogadoPeer';
	...
	/**
	 * @var        array AdvogadoInscricaoOab[] Collection to store aggregation of AdvogadoInscricaoOab objects.
	 */
	protected $collAdvogadoInscricaoOabs;

	/**
	 * @var        array AvaliacaoAdvogado[] Collection to store aggregation of AvaliacaoAdvogado objects.
	 */
	protected $collAvaliacaoAdvogados;
	...
	/**
	 * @var        array LocalizacaoAdvogado[] Collection to store aggregation of LocalizacaoAdvogado objects.
	 */
	protected $collLocalizacaoAdvogados;
	...
	/**
	 * @var        array Titulo[] Collection to store aggregation of Titulo objects.
	 */
	protected $collTitulos;

	/**
	 * @var        array AreaAdvocacia[] Collection to store aggregation of AreaAdvocacia objects.
	 */
	protected $collAreaAdvocacias;
	 ...
	 * @var		array
	 */
	protected $areaAdvocaciasScheduledForDeletion = null;
	 ...
	 * @var		array
	 */
	protected $advogadoInscricaoOabsScheduledForDeletion = null;

	/**
	 * An array of objects scheduled for deletion.
	 * @var		array
	 */
	protected $avaliacaoAdvogadosScheduledForDeletion = null;
	 ...
	 * @var		array
	 */
	protected $localizacaoAdvogadosScheduledForDeletion = null;
	 ...
	 * @var		array
	 */
	protected $titulosScheduledForDeletion = null;
	...
	/**
	 * Initializes internal state of BaseAdvogado object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Advogado The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AdvogadoPeer::ID;
		}
	...
	public function setUsuarioId($v)
	{
		...
		if ($this->usuario_id !== $v) {
			$this->usuario_id = $v;
			$this->modifiedColumns[] = AdvogadoPeer::USUARIO_ID;
		}
	...
	public function setEnderecoId($v)
	{
		...
		if ($this->endereco_id !== $v) {
			$this->endereco_id = $v;
			$this->modifiedColumns[] = AdvogadoPeer::ENDERECO_ID;
		}
	...
	public function setNome($v)
	{
		...
		if ($this->nome !== $v) {
			$this->nome = $v;
			$this->modifiedColumns[] = AdvogadoPeer::NOME;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = AdvogadoPeer::EMAIL;
		}
	...
	public function setTelefone($v)
	{
		...
		if ($this->telefone !== $v) {
			$this->telefone = $v;
			$this->modifiedColumns[] = AdvogadoPeer::TELEFONE;
		}
	...
	public function setCelular($v)
	{
		...
		if ($this->celular !== $v) {
			$this->celular = $v;
			$this->modifiedColumns[] = AdvogadoPeer::CELULAR;
		}
	...
	public function setRg($v)
	{
		...
		if ($this->rg !== $v) {
			$this->rg = $v;
			$this->modifiedColumns[] = AdvogadoPeer::RG;
		}
	...
	public function setRgExpedidor($v)
	{
		...
		if ($this->rg_expedidor !== $v) {
			$this->rg_expedidor = $v;
			$this->modifiedColumns[] = AdvogadoPeer::RG_EXPEDIDOR;
		}
	...
	public function setCadastroValido($v)
	{
		...
		if ($this->cadastro_valido !== $v) {
			...
			$this->modifiedColumns[] = AdvogadoPeer::CADASTRO_VALIDO;
		}
	...
	public function setDataNascimento($v)
	{
		...
		if ($this->data_nascimento !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = AdvogadoPeer::DATA_NASCIMENTO;
			}
	...
	public function setSexo($v)
	{
		...
		if ($this->sexo !== $v) {
			$this->sexo = $v;
			$this->modifiedColumns[] = AdvogadoPeer::SEXO;
		}
	...
	public function setFacebook($v)
	{
		...
		if ($this->facebook !== $v) {
			$this->facebook = $v;
			$this->modifiedColumns[] = AdvogadoPeer::FACEBOOK;
		}
	...
	public function setInstagram($v)
	{
		...
		if ($this->instagram !== $v) {
			$this->instagram = $v;
			$this->modifiedColumns[] = AdvogadoPeer::INSTAGRAM;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->rg = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->rg_expedidor = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->cadastro_valido = ($row[$startcol + 10] !== null) ? (boolean) $row[$startcol + 10] : null;
			$this->data_nascimento = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->sexo = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->facebook = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->instagram = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->resetModified();
			...
			return $startcol + 15; // 15 = AdvogadoPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Advogado object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AdvogadoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collAdvogadoInscricaoOabs = null;

			$this->collAvaliacaoAdvogados = null;

			$this->collCasos = null;

			$this->collContratos = null;

			$this->collLocalizacaoAdvogados = null;

			$this->collProcessos = null;

			$this->collSolicitacaos = null;

			$this->collTitulos = null;

			$this->collAreaAdvocacias = null;
	...
	public function delete(PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(AdvogadoPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}

		$con->beginTransaction();
		try {
			$deleteQuery = AdvogadoQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AdvogadoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->areaAdvocaciasScheduledForDeletion !== null) {
				if (!$this->areaAdvocaciasScheduledForDeletion->isEmpty()) {
					AdvogadoAreaAdvocaciaQuery::create()
						->filterByPrimaryKeys($this->areaAdvocaciasScheduledForDeletion->getPrimaryKeys(false))
						->delete($con);
					$this->areaAdvocaciasScheduledForDeletion = null;
				}

				foreach ($this->getAreaAdvocacias() as $areaAdvocacia) {
					if ($areaAdvocacia->isModified()) {
						$areaAdvocacia->save($con);
					}
				}
			}
			...
			if ($this->advogadoInscricaoOabsScheduledForDeletion !== null) {
				if (!$this->advogadoInscricaoOabsScheduledForDeletion->isEmpty()) {
					AdvogadoInscricaoOabQuery::create()
						->filterByPrimaryKeys($this->advogadoInscricaoOabsScheduledForDeletion->getPrimaryKeys(false))
						->delete($con);
					$this->advogadoInscricaoOabsScheduledForDeletion = null;
				}
			}

			if ($this->collAdvogadoInscricaoOabs !== null) {
				foreach ($this->collAdvogadoInscricaoOabs as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->avaliacaoAdvogadosScheduledForDeletion !== null) {
				if (!$this->avaliacaoAdvogadosScheduledForDeletion->isEmpty()) {
					AvaliacaoAdvogadoQuery::create()
						->filterByPrimaryKeys($this->avaliacaoAdvogadosScheduledForDeletion->getPrimaryKeys(false))
						->delete($con);
					$this->avaliacaoAdvogadosScheduledForDeletion = null;
				}
			}

			if ($this->collAvaliacaoAdvogados !== null) {
				foreach ($this->collAvaliacaoAdvogados as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->localizacaoAdvogadosScheduledForDeletion !== null) {
				if (!$this->localizacaoAdvogadosScheduledForDeletion->isEmpty()) {
					LocalizacaoAdvogadoQuery::create()
						->filterByPrimaryKeys($this->localizacaoAdvogadosScheduledForDeletion->getPrimaryKeys(false))
						->delete($con);
					$this->localizacaoAdvogadosScheduledForDeletion = null;
				}
			}

			if ($this->collLocalizacaoAdvogados !== null) {
				foreach ($this->collLocalizacaoAdvogados as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->titulosScheduledForDeletion !== null) {
				if (!$this->titulosScheduledForDeletion->isEmpty()) {
					TituloQuery::create()
						->filterByPrimaryKeys($this->titulosScheduledForDeletion->getPrimaryKeys(false))
						->delete($con);
					$this->titulosScheduledForDeletion = null;
				}
			}

			if ($this->collTitulos !== null) {
				foreach ($this->collTitulos as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		$this->modifiedColumns[] = AdvogadoPeer::ID;
		if (null !== $this->id) {
			throw new PropelException('Cannot insert a value for auto-increment primary key (' . AdvogadoPeer::ID . ')');
		}

		 // check the columns in natural order for more readable SQL queries
		if ($this->isColumnModified(AdvogadoPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(AdvogadoPeer::USUARIO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`USUARIO_ID`';
		}
		if ($this->isColumnModified(AdvogadoPeer::ENDERECO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ENDERECO_ID`';
		}
		if ($this->isColumnModified(AdvogadoPeer::NOME)) {
			$modifiedColumns[':p' . $index++]  = '`NOME`';
		}
		if ($this->isColumnModified(AdvogadoPeer::EMAIL)) {
			$modifiedColumns[':p' . $index++]  = '`EMAIL`';
		}
		if ($this->isColumnModified(AdvogadoPeer::TELEFONE)) {
			$modifiedColumns[':p' . $index++]  = '`TELEFONE`';
		}
		if ($this->isColumnModified(AdvogadoPeer::CELULAR)) {
			$modifiedColumns[':p' . $index++]  = '`CELULAR`';
		}
		if ($this->isColumnModified(AdvogadoPeer::CPF)) {
			$modifiedColumns[':p' . $index++]  = '`CPF`';
		}
		if ($this->isColumnModified(AdvogadoPeer::RG)) {
			$modifiedColumns[':p' . $index++]  = '`RG`';
		}
		if ($this->isColumnModified(AdvogadoPeer::RG_EXPEDIDOR)) {
			$modifiedColumns[':p' . $index++]  = '`RG_EXPEDIDOR`';
		}
		if ($this->isColumnModified(AdvogadoPeer::CADASTRO_VALIDO)) {
			$modifiedColumns[':p' . $index++]  = '`CADASTRO_VALIDO`';
		}
		if ($this->isColumnModified(AdvogadoPeer::DATA_NASCIMENTO)) {
			$modifiedColumns[':p' . $index++]  = '`DATA_NASCIMENTO`';
		}
		if ($this->isColumnModified(AdvogadoPeer::SEXO)) {
			$modifiedColumns[':p' . $index++]  = '`SEXO`';
		}
		if ($this->isColumnModified(AdvogadoPeer::FACEBOOK)) {
			$modifiedColumns[':p' . $index++]  = '`FACEBOOK`';
		}
		if ($this->isColumnModified(AdvogadoPeer::INSTAGRAM)) {
			$modifiedColumns[':p' . $index++]  = '`INSTAGRAM`';
		}

		$sql = sprintf(
			'INSERT INTO `advogado` (%s) VALUES (%s)',
	...
	{
		$pos = AdvogadoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Advogado'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Advogado'][$this->getPrimaryKey()] = true;
		$keys = AdvogadoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			...
			$keys[7] => $this->getCpf(),
			$keys[8] => $this->getRg(),
			$keys[9] => $this->getRgExpedidor(),
			$keys[10] => $this->getCadastroValido(),
			$keys[11] => $this->getDataNascimento(),
			$keys[12] => $this->getSexo(),
			$keys[13] => $this->getFacebook(),
			$keys[14] => $this->getInstagram(),
		);
		if ($includeForeignObjects) {
			...
			if (null !== $this->collAdvogadoInscricaoOabs) {
				$result['AdvogadoInscricaoOabs'] = $this->collAdvogadoInscricaoOabs->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
			}
			if (null !== $this->collAvaliacaoAdvogados) {
				$result['AvaliacaoAdvogados'] = $this->collAvaliacaoAdvogados->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
			}
			...
			if (null !== $this->collLocalizacaoAdvogados) {
				$result['LocalizacaoAdvogados'] = $this->collLocalizacaoAdvogados->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
			}
			...
			if (null !== $this->collTitulos) {
				$result['Titulos'] = $this->collTitulos->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
			}
		}
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setCpf($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setRg($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setRgExpedidor($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setCadastroValido($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setDataNascimento($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setSexo($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setFacebook($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setInstagram($arr[$keys[14]]);
	}
	...
	{
		$criteria = new Criteria(AdvogadoPeer::DATABASE_NAME);

		if ($this->isColumnModified(AdvogadoPeer::ID)) $criteria->add(AdvogadoPeer::ID, $this->id);
		if ($this->isColumnModified(AdvogadoPeer::USUARIO_ID)) $criteria->add(AdvogadoPeer::USUARIO_ID, $this->usuario_id);
		if ($this->isColumnModified(AdvogadoPeer::ENDERECO_ID)) $criteria->add(AdvogadoPeer::ENDERECO_ID, $this->endereco_id);
		if ($this->isColumnModified(AdvogadoPeer::NOME)) $criteria->add(AdvogadoPeer::NOME, $this->nome);
		if ($this->isColumnModified(AdvogadoPeer::EMAIL)) $criteria->add(AdvogadoPeer::EMAIL, $this->email);
		if ($this->isColumnModified(AdvogadoPeer::TELEFONE)) $criteria->add(AdvogadoPeer::TELEFONE, $this->telefone);
		if ($this->isColumnModified(AdvogadoPeer::CELULAR)) $criteria->add(AdvogadoPeer::CELULAR, $this->celular);
		if ($this->isColumnModified(AdvogadoPeer::CPF)) $criteria->add(AdvogadoPeer::CPF, $this->cpf);
		if ($this->isColumnModified(AdvogadoPeer::RG)) $criteria->add(AdvogadoPeer::RG, $this->rg);
		if ($this->isColumnModified(AdvogadoPeer::RG_EXPEDIDOR)) $criteria->add(AdvogadoPeer::RG_EXPEDIDOR, $this->rg_expedidor);
		if ($this->isColumnModified(AdvogadoPeer::CADASTRO_VALIDO)) $criteria->add(AdvogadoPeer::CADASTRO_VALIDO, $this->cadastro_valido);
		if ($this->isColumnModified(AdvogadoPeer::DATA_NASCIMENTO)) $criteria->add(AdvogadoPeer::DATA_NASCIMENTO, $this->data_nascimento);
		if ($this->isColumnModified(AdvogadoPeer::SEXO)) $criteria->add(AdvogadoPeer::SEXO, $this->sexo);
		if ($this->isColumnModified(AdvogadoPeer::FACEBOOK)) $criteria->add(AdvogadoPeer::FACEBOOK, $this->facebook);
		if ($this->isColumnModified(AdvogadoPeer::INSTAGRAM)) $criteria->add(AdvogadoPeer::INSTAGRAM, $this->instagram);
	...
	{
		$criteria = new Criteria(AdvogadoPeer::DATABASE_NAME);
		$criteria->add(AdvogadoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Advogado (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		if ($deepCopy && !$this->startCopy) {
			...
			foreach ($this->getAdvogadoInscricaoOabs() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addAdvogadoInscricaoOab($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getAvaliacaoAdvogados() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addAvaliacaoAdvogado($relObj->copy($deepCopy));
				}
			}
			...
			foreach ($this->getLocalizacaoAdvogados() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addLocalizacaoAdvogado($relObj->copy($deepCopy));
				}
			}
			...
			foreach ($this->getTitulos() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addTitulo($relObj->copy($deepCopy));
				}
			}
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Advogado Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getEndereco(PropelPDO $con = null)
	{
		if ($this->aEndereco === null && ($this->endereco_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aEndereco->addAdvogados($this);
			 */
		}
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && ($this->usuario_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUsuario->addAdvogados($this);
			 */
		}
	...
	public function initRelation($relationName)
	{
		...
		if ('AdvogadoInscricaoOab' == $relationName) {
			return $this->initAdvogadoInscricaoOabs();
		}
		if ('AvaliacaoAdvogado' == $relationName) {
			return $this->initAvaliacaoAdvogados();
		}
		...
		if ('LocalizacaoAdvogado' == $relationName) {
			return $this->initLocalizacaoAdvogados();
		}
		...
		if ('Titulo' == $relationName) {
			return $this->initTitulos();
		}
	}
	 ...
	 * If this Advogado is new, it will return
	...
	public function setAdvogadoAreaAdvocacias(PropelCollection $advogadoAreaAdvocacias, PropelPDO $con = null)
	{
		...
		foreach ($advogadoAreaAdvocacias as $advogadoAreaAdvocacia) {
			...
			if ($advogadoAreaAdvocacia->isNew()) {
				$advogadoAreaAdvocacia->setAdvogado($this);
			}
	 ...
	 * Otherwise if this Advogado is new, it will return
	 * an empty collection; or if this Advogado has previously
	 * been saved, it will retrieve related AdvogadoAreaAdvocacias from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Advogado.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array AdvogadoAreaAdvocacia[] List of AdvogadoAreaAdvocacia objects
	 */
	public function getAdvogadoAreaAdvocaciasJoinAreaAdvocacia($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = AdvogadoAreaAdvocaciaQuery::create(null, $criteria);
	...
	public function setAdvogadoClientes(PropelCollection $advogadoClientes, PropelPDO $con = null)
	{
		...
		foreach ($advogadoClientes as $advogadoCliente) {
			...
			if ($advogadoCliente->isNew()) {
				$advogadoCliente->setAdvogado($this);
			}
	 ...
	 * @return     PropelCollection|array AdvogadoCliente[] List of AdvogadoCliente objects
	 */
	public function getAdvogadoClientesJoinCliente($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = AdvogadoClienteQuery::create(null, $criteria);
	...
	/**
	 * Clears out the collAdvogadoInscricaoOabs collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addAdvogadoInscricaoOabs()
	 */
	public function clearAdvogadoInscricaoOabs()
	{
		$this->collAdvogadoInscricaoOabs = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collAdvogadoInscricaoOabs collection.
	 *
	 * By default this just sets the collAdvogadoInscricaoOabs collection to an empty array (like clearcollAdvogadoInscricaoOabs());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @param      boolean $overrideExisting If set to true, the method call initializes
	 ...
	 * @return     void
	 */
	public function initAdvogadoInscricaoOabs($overrideExisting = true)
	{
		if (null !== $this->collAdvogadoInscricaoOabs && !$overrideExisting) {
			return;
		}
		$this->collAdvogadoInscricaoOabs = new PropelObjectCollection();
		$this->collAdvogadoInscricaoOabs->setModel('AdvogadoInscricaoOab');
	}

	/**
	 * Gets an array of AdvogadoInscricaoOab objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array AdvogadoInscricaoOab[] List of AdvogadoInscricaoOab objects
	 * @throws     PropelException
	 */
	public function getAdvogadoInscricaoOabs($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collAdvogadoInscricaoOabs || null !== $criteria) {
			if ($this->isNew() && null === $this->collAdvogadoInscricaoOabs) {
				// return empty collection
				$this->initAdvogadoInscricaoOabs();
			} else {
				$collAdvogadoInscricaoOabs = AdvogadoInscricaoOabQuery::create(null, $criteria)
					->filterByAdvogado($this)
					->find($con);
				if (null !== $criteria) {
					return $collAdvogadoInscricaoOabs;
				}
				$this->collAdvogadoInscricaoOabs = $collAdvogadoInscricaoOabs;
			}
		}
		return $this->collAdvogadoInscricaoOabs;
	}

	/**
	 * Sets a collection of AdvogadoInscricaoOab objects related by a one-to-many relationship
	 * to the current object.
	 * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $advogadoInscricaoOabs A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	public function setAdvogadoInscricaoOabs(PropelCollection $advogadoInscricaoOabs, PropelPDO $con = null)
	{
		$this->advogadoInscricaoOabsScheduledForDeletion = $this->getAdvogadoInscricaoOabs(new Criteria(), $con)->diff($advogadoInscricaoOabs);

		foreach ($advogadoInscricaoOabs as $advogadoInscricaoOab) {
			// Fix issue with collection modified by reference
			if ($advogadoInscricaoOab->isNew()) {
				$advogadoInscricaoOab->setAdvogado($this);
			}
			$this->addAdvogadoInscricaoOab($advogadoInscricaoOab);
		}

		$this->collAdvogadoInscricaoOabs = $advogadoInscricaoOabs;
	}

	/**
	 * Returns the number of related AdvogadoInscricaoOab objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related AdvogadoInscricaoOab objects.
	 * @throws     PropelException
	 */
	public function countAdvogadoInscricaoOabs(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collAdvogadoInscricaoOabs || null !== $criteria) {
			if ($this->isNew() && null === $this->collAdvogadoInscricaoOabs) {
				return 0;
			} else {
				$query = AdvogadoInscricaoOabQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
			...
			return count($this->collAdvogadoInscricaoOabs);
		}
	}

	/**
	 * Method called to associate a AdvogadoInscricaoOab object to this object
	 * through the AdvogadoInscricaoOab foreign key attribute.
	 *
	 * @param      AdvogadoInscricaoOab $l AdvogadoInscricaoOab
	 * @return     Advogado The current object (for fluent API support)
	 */
	public function addAdvogadoInscricaoOab(AdvogadoInscricaoOab $l)
	{
		if ($this->collAdvogadoInscricaoOabs === null) {
			$this->initAdvogadoInscricaoOabs();
		}
		if (!$this->collAdvogadoInscricaoOabs->contains($l)) { // only add it if the **same** object is not already associated
			$this->doAddAdvogadoInscricaoOab($l);
		}
	...
	/**
	 * @param	AdvogadoInscricaoOab $advogadoInscricaoOab The advogadoInscricaoOab object to add.
	 */
	protected function doAddAdvogadoInscricaoOab($advogadoInscricaoOab)
	{
		$this->collAdvogadoInscricaoOabs[]= $advogadoInscricaoOab;
		$advogadoInscricaoOab->setAdvogado($this);
	}
	 ...
	 * Otherwise if this Advogado is new, it will return
	 * an empty collection; or if this Advogado has previously
	 * been saved, it will retrieve related AdvogadoInscricaoOabs from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Advogado.
	 ...
	 * @return     PropelCollection|array AdvogadoInscricaoOab[] List of AdvogadoInscricaoOab objects
	 */
	public function getAdvogadoInscricaoOabsJoinUf($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = AdvogadoInscricaoOabQuery::create(null, $criteria);
		$query->joinWith('Uf', $join_behavior);

		return $this->getAdvogadoInscricaoOabs($query, $con);
	}

	/**
	 * Clears out the collAvaliacaoAdvogados collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addAvaliacaoAdvogados()
	 */
	public function clearAvaliacaoAdvogados()
	{
		$this->collAvaliacaoAdvogados = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collAvaliacaoAdvogados collection.
	 *
	 * By default this just sets the collAvaliacaoAdvogados collection to an empty array (like clearcollAvaliacaoAdvogados());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @param      boolean $overrideExisting If set to true, the method call initializes
	 ...
	 * @return     void
	 */
	public function initAvaliacaoAdvogados($overrideExisting = true)
	{
		if (null !== $this->collAvaliacaoAdvogados && !$overrideExisting) {
			return;
		}
		$this->collAvaliacaoAdvogados = new PropelObjectCollection();
		$this->collAvaliacaoAdvogados->setModel('AvaliacaoAdvogado');
	}

	/**
	 * Gets an array of AvaliacaoAdvogado objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array AvaliacaoAdvogado[] List of AvaliacaoAdvogado objects
	 * @throws     PropelException
	 */
	public function getAvaliacaoAdvogados($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collAvaliacaoAdvogados || null !== $criteria) {
			if ($this->isNew() && null === $this->collAvaliacaoAdvogados) {
				// return empty collection
				$this->initAvaliacaoAdvogados();
			} else {
				$collAvaliacaoAdvogados = AvaliacaoAdvogadoQuery::create(null, $criteria)
					->filterByAdvogado($this)
					->find($con);
				if (null !== $criteria) {
					return $collAvaliacaoAdvogados;
				}
				$this->collAvaliacaoAdvogados = $collAvaliacaoAdvogados;
			}
		}
		return $this->collAvaliacaoAdvogados;
	}

	/**
	 * Sets a collection of AvaliacaoAdvogado objects related by a one-to-many relationship
	 * to the current object.
	 * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $avaliacaoAdvogados A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	public function setAvaliacaoAdvogados(PropelCollection $avaliacaoAdvogados, PropelPDO $con = null)
	{
		$this->avaliacaoAdvogadosScheduledForDeletion = $this->getAvaliacaoAdvogados(new Criteria(), $con)->diff($avaliacaoAdvogados);

		foreach ($avaliacaoAdvogados as $avaliacaoAdvogado) {
			// Fix issue with collection modified by reference
			if ($avaliacaoAdvogado->isNew()) {
				$avaliacaoAdvogado->setAdvogado($this);
			}
			$this->addAvaliacaoAdvogado($avaliacaoAdvogado);
		}

		$this->collAvaliacaoAdvogados = $avaliacaoAdvogados;
	}

	/**
	 * Returns the number of related AvaliacaoAdvogado objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related AvaliacaoAdvogado objects.
	 * @throws     PropelException
	 */
	public function countAvaliacaoAdvogados(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collAvaliacaoAdvogados || null !== $criteria) {
			if ($this->isNew() && null === $this->collAvaliacaoAdvogados) {
				return 0;
			} else {
				$query = AvaliacaoAdvogadoQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
			...
			return count($this->collAvaliacaoAdvogados);
		}
	}

	/**
	 * Method called to associate a AvaliacaoAdvogado object to this object
	 * through the AvaliacaoAdvogado foreign key attribute.
	 *
	 * @param      AvaliacaoAdvogado $l AvaliacaoAdvogado
	 * @return     Advogado The current object (for fluent API support)
	 */
	public function addAvaliacaoAdvogado(AvaliacaoAdvogado $l)
	{
		if ($this->collAvaliacaoAdvogados === null) {
			$this->initAvaliacaoAdvogados();
		}
		if (!$this->collAvaliacaoAdvogados->contains($l)) { // only add it if the **same** object is not already associated
			$this->doAddAvaliacaoAdvogado($l);
		}
	...
	/**
	 * @param	AvaliacaoAdvogado $avaliacaoAdvogado The avaliacaoAdvogado object to add.
	 */
	protected function doAddAvaliacaoAdvogado($avaliacaoAdvogado)
	{
		$this->collAvaliacaoAdvogados[]= $avaliacaoAdvogado;
		$avaliacaoAdvogado->setAdvogado($this);
	}
	 ...
	 * Otherwise if this Advogado is new, it will return
	 * an empty collection; or if this Advogado has previously
	 * been saved, it will retrieve related AvaliacaoAdvogados from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Advogado.
	 ...
	 * @return     PropelCollection|array AvaliacaoAdvogado[] List of AvaliacaoAdvogado objects
	 */
	public function getAvaliacaoAdvogadosJoinUsuario($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = AvaliacaoAdvogadoQuery::create(null, $criteria);
		$query->joinWith('Usuario', $join_behavior);

		return $this->getAvaliacaoAdvogados($query, $con);
	}
	...
	/**
	 * Clears out the collLocalizacaoAdvogados collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addLocalizacaoAdvogados()
	 */
	public function clearLocalizacaoAdvogados()
	{
		$this->collLocalizacaoAdvogados = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collLocalizacaoAdvogados collection.
	 *
	 * By default this just sets the collLocalizacaoAdvogados collection to an empty array (like clearcollLocalizacaoAdvogados());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @param      boolean $overrideExisting If set to true, the method call initializes
	 ...
	 * @return     void
	 */
	public function initLocalizacaoAdvogados($overrideExisting = true)
	{
		if (null !== $this->collLocalizacaoAdvogados && !$overrideExisting) {
			return;
		}
		$this->collLocalizacaoAdvogados = new PropelObjectCollection();
		$this->collLocalizacaoAdvogados->setModel('LocalizacaoAdvogado');
	}

	/**
	 * Gets an array of LocalizacaoAdvogado objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array LocalizacaoAdvogado[] List of LocalizacaoAdvogado objects
	 * @throws     PropelException
	 */
	public function getLocalizacaoAdvogados($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collLocalizacaoAdvogados || null !== $criteria) {
			if ($this->isNew() && null === $this->collLocalizacaoAdvogados) {
				// return empty collection
				$this->initLocalizacaoAdvogados();
			} else {
				$collLocalizacaoAdvogados = LocalizacaoAdvogadoQuery::create(null, $criteria)
					->filterByAdvogado($this)
					->find($con);
				if (null !== $criteria) {
					return $collLocalizacaoAdvogados;
				}
				$this->collLocalizacaoAdvogados = $collLocalizacaoAdvogados;
			}
		}
		return $this->collLocalizacaoAdvogados;
	}

	/**
	 * Sets a collection of LocalizacaoAdvogado objects related by a one-to-many relationship
	 * to the current object.
	 * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $localizacaoAdvogados A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	...
	/**
	 * Returns the number of related LocalizacaoAdvogado objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related LocalizacaoAdvogado objects.
	 * @throws     PropelException
	 */
	public function countLocalizacaoAdvogados(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collLocalizacaoAdvogados || null !== $criteria) {
			if ($this->isNew() && null === $this->collLocalizacaoAdvogados) {
				return 0;
			} else {
				$query = LocalizacaoAdvogadoQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
			...
			return count($this->collLocalizacaoAdvogados);
		}
	}

	/**
	 * Method called to associate a LocalizacaoAdvogado object to this object
	 * through the LocalizacaoAdvogado foreign key attribute.
	 *
	 * @param      LocalizacaoAdvogado $l LocalizacaoAdvogado
	 * @return     Advogado The current object (for fluent API support)
	 */
	public function addLocalizacaoAdvogado(LocalizacaoAdvogado $l)
	{
		if ($this->collLocalizacaoAdvogados === null) {
			$this->initLocalizacaoAdvogados();
		}
		if (!$this->collLocalizacaoAdvogados->contains($l)) { // only add it if the **same** object is not already associated
			$this->doAddLocalizacaoAdvogado($l);
		}
	...
	/**
	 * @param	LocalizacaoAdvogado $localizacaoAdvogado The localizacaoAdvogado object to add.
	 */
	protected function doAddLocalizacaoAdvogado($localizacaoAdvogado)
	{
		$this->collLocalizacaoAdvogados[]= $localizacaoAdvogado;
		$localizacaoAdvogado->setAdvogado($this);
	}
	...
	/**
	 * Clears out the collTitulos collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addTitulos()
	 */
	public function clearTitulos()
	{
		$this->collTitulos = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTitulos collection.
	 *
	 * By default this just sets the collTitulos collection to an empty array (like clearcollTitulos());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @param      boolean $overrideExisting If set to true, the method call initializes
	 ...
	 * @return     void
	 */
	public function initTitulos($overrideExisting = true)
	{
		if (null !== $this->collTitulos && !$overrideExisting) {
			return;
		}
		$this->collTitulos = new PropelObjectCollection();
		$this->collTitulos->setModel('Titulo');
	}

	/**
	 * Gets an array of Titulo objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array Titulo[] List of Titulo objects
	 * @throws     PropelException
	 */
	public function getTitulos($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collTitulos || null !== $criteria) {
			if ($this->isNew() && null === $this->collTitulos) {
				// return empty collection
				$this->initTitulos();
			} else {
				$collTitulos = TituloQuery::create(null, $criteria)
					->filterByAdvogado($this)
					->find($con);
				if (null !== $criteria) {
					return $collTitulos;
				}
				$this->collTitulos = $collTitulos;
			}
		}
		return $this->collTitulos;
	}

	/**
	 * Sets a collection of Titulo objects related by a one-to-many relationship
	 * to the current object.
	 * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $titulos A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	public function setTitulos(PropelCollection $titulos, PropelPDO $con = null)
	{
		$this->titulosScheduledForDeletion = $this->getTitulos(new Criteria(), $con)->diff($titulos);

		foreach ($titulos as $titulo) {
			// Fix issue with collection modified by reference
			if ($titulo->isNew()) {
				$titulo->setAdvogado($this);
			}
			$this->addTitulo($titulo);
		}

		$this->collTitulos = $titulos;
	}

	/**
	 * Returns the number of related Titulo objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Titulo objects.
	 * @throws     PropelException
	 */
	public function countTitulos(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collTitulos || null !== $criteria) {
			if ($this->isNew() && null === $this->collTitulos) {
				return 0;
			} else {
				$query = TituloQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
			...
			return count($this->collTitulos);
		}
	}

	/**
	 * Method called to associate a Titulo object to this object
	 * through the Titulo foreign key attribute.
	 *
	 * @param      Titulo $l Titulo
	 * @return     Advogado The current object (for fluent API support)
	 */
	public function addTitulo(Titulo $l)
	{
		if ($this->collTitulos === null) {
			$this->initTitulos();
		}
		if (!$this->collTitulos->contains($l)) { // only add it if the **same** object is not already associated
			$this->doAddTitulo($l);
		}
	...
	/**
	 * @param	Titulo $titulo The titulo object to add.
	 */
	protected function doAddTitulo($titulo)
	{
		$this->collTitulos[]= $titulo;
		$titulo->setAdvogado($this);
	}

	/**
	 * Clears out the collAreaAdvocacias collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addAreaAdvocacias()
	 */
	public function clearAreaAdvocacias()
	{
		$this->collAreaAdvocacias = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collAreaAdvocacias collection.
	 *
	 * By default this just sets the collAreaAdvocacias collection to an empty collection (like clearAreaAdvocacias());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initAreaAdvocacias()
	{
		$this->collAreaAdvocacias = new PropelObjectCollection();
		$this->collAreaAdvocacias->setModel('AreaAdvocacia');
	}

	/**
	 * Gets a collection of AreaAdvocacia objects related by a many-to-many relationship
	 ...
	 * @param      PropelPDO $con Optional connection object
	 *
	 * @return     PropelCollection|array AreaAdvocacia[] List of AreaAdvocacia objects
	 */
	public function getAreaAdvocacias($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collAreaAdvocacias || null !== $criteria) {
			if ($this->isNew() && null === $this->collAreaAdvocacias) {
				// return empty collection
				$this->initAreaAdvocacias();
			} else {
				$collAreaAdvocacias = AreaAdvocaciaQuery::create(null, $criteria)
					->filterByAdvogado($this)
					->find($con);
				if (null !== $criteria) {
					return $collAreaAdvocacias;
				}
				$this->collAreaAdvocacias = $collAreaAdvocacias;
			}
		}
		return $this->collAreaAdvocacias;
	}

	/**
	 * Sets a collection of AreaAdvocacia objects related by a many-to-many relationship
	 * to the current object by way of the advogado_area_advocacia cross-reference table.
	 * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $areaAdvocacias A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	public function setAreaAdvocacias(PropelCollection $areaAdvocacias, PropelPDO $con = null)
	{
		$advogadoAreaAdvocacias = AdvogadoAreaAdvocaciaQuery::create()
			->filterByAreaAdvocacia($areaAdvocacias)
			->filterByAdvogado($this)
			->find($con);

		$this->areaAdvocaciasScheduledForDeletion = $this->getAdvogadoAreaAdvocacias()->diff($advogadoAreaAdvocacias);
		$this->collAdvogadoAreaAdvocacias = $advogadoAreaAdvocacias;

		foreach ($areaAdvocacias as $areaAdvocacia) {
			// Fix issue with collection modified by reference
			if ($areaAdvocacia->isNew()) {
				$this->doAddAreaAdvocacia($areaAdvocacia);
			} else {
				$this->addAreaAdvocacia($areaAdvocacia);
			}
		}

		$this->collAreaAdvocacias = $areaAdvocacias;
	}

	/**
	 * Gets the number of AreaAdvocacia objects related by a many-to-many relationship
	 * to the current object by way of the advogado_area_advocacia cross-reference table.
	 *
	 * @param      Criteria $criteria Optional query object to filter the query
	 ...
	 * @param      PropelPDO $con Optional connection object
	 *
	 * @return     int the number of related AreaAdvocacia objects
	 */
	public function countAreaAdvocacias($criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collAreaAdvocacias || null !== $criteria) {
			if ($this->isNew() && null === $this->collAreaAdvocacias) {
				return 0;
			} else {
				$query = AreaAdvocaciaQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
			...
			return count($this->collAreaAdvocacias);
		}
	}

	/**
	 * Associate a AreaAdvocacia object to this object
	 * through the advogado_area_advocacia cross reference table.
	 *
	 * @param      AreaAdvocacia $areaAdvocacia The AdvogadoAreaAdvocacia object to relate
	 * @return     void
	 */
	public function addAreaAdvocacia(AreaAdvocacia $areaAdvocacia)
	{
		if ($this->collAreaAdvocacias === null) {
			$this->initAreaAdvocacias();
		}
		if (!$this->collAreaAdvocacias->contains($areaAdvocacia)) { // only add it if the **same** object is not already associated
			$this->doAddAreaAdvocacia($areaAdvocacia);

			$this->collAreaAdvocacias[]= $areaAdvocacia;
		}
	}

	/**
	 * @param	AreaAdvocacia $areaAdvocacia The areaAdvocacia object to add.
	 */
	protected function doAddAreaAdvocacia($areaAdvocacia)
	{
		$advogadoAreaAdvocacia = new AdvogadoAreaAdvocacia();
		$advogadoAreaAdvocacia->setAreaAdvocacia($areaAdvocacia);
		$this->addAdvogadoAreaAdvocacia($advogadoAreaAdvocacia);
	}
	 ...
	 *
	 * By default this just sets the collClientes collection to an empty collection (like clearClientes());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	...
	/**
	 * Gets a collection of Cliente objects related by a many-to-many relationship
	...
	/**
	 * Sets a collection of Cliente objects related by a many-to-many relationship
	 * to the current object by way of the advogado_cliente cross-reference table.
	 * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
	 * and new objects from the given Propel collection.
	 *
	...
	public function setClientes(PropelCollection $clientes, PropelPDO $con = null)
	{
		$advogadoClientes = AdvogadoClienteQuery::create()
			->filterByCliente($clientes)
			->filterByAdvogado($this)
			->find($con);

		$this->clientesScheduledForDeletion = $this->getAdvogadoClientes()->diff($advogadoClientes);
		$this->collAdvogadoClientes = $advogadoClientes;

		foreach ($clientes as $cliente) {
			// Fix issue with collection modified by reference
			if ($cliente->isNew()) {
				$this->doAddCliente($cliente);
			} else {
	...
	/**
	 * Gets the number of Cliente objects related by a many-to-many relationship
	 * to the current object by way of the advogado_cliente cross-reference table.
	 *
	 * @param      Criteria $criteria Optional query object to filter the query
	 * @param      boolean $distinct Set to true to force count distinct
	 * @param      PropelPDO $con Optional connection object
	 *
	 * @return     int the number of related Cliente objects
	 */
	public function countClientes($criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collClientes || null !== $criteria) {
			if ($this->isNew() && null === $this->collClientes) {
				return 0;
	...
	/**
	 * Associate a Cliente object to this object
	 * through the advogado_cliente cross reference table.
	 *
	 * @param      Cliente $cliente The AdvogadoCliente object to relate
	 * @return     void
	 */
	public function addCliente(Cliente $cliente)
	{
		...
		if (!$this->collClientes->contains($cliente)) { // only add it if the **same** object is not already associated
			$this->doAddCliente($cliente);
	...
	protected function doAddCliente($cliente)
	{
		...
		$advogadoCliente->setCliente($cliente);
		$this->addAdvogadoCliente($advogadoCliente);
	}
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collAdvogadoInscricaoOabs) {
				foreach ($this->collAdvogadoInscricaoOabs as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collAvaliacaoAdvogados) {
				foreach ($this->collAvaliacaoAdvogados as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collCasos) {
			...
			if ($this->collLocalizacaoAdvogados) {
				foreach ($this->collLocalizacaoAdvogados as $o) {
					$o->clearAllReferences($deep);
				}
			}
			...
			if ($this->collTitulos) {
				foreach ($this->collTitulos as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collAreaAdvocacias) {
				foreach ($this->collAreaAdvocacias as $o) {
					$o->clearAllReferences($deep);
				}
			}
		...
		$this->collAdvogadoClientes = null;
		if ($this->collAdvogadoInscricaoOabs instanceof PropelCollection) {
			$this->collAdvogadoInscricaoOabs->clearIterator();
		}
		$this->collAdvogadoInscricaoOabs = null;
		if ($this->collAvaliacaoAdvogados instanceof PropelCollection) {
			$this->collAvaliacaoAdvogados->clearIterator();
		}
		$this->collAvaliacaoAdvogados = null;
		...
		$this->collContratos = null;
		if ($this->collLocalizacaoAdvogados instanceof PropelCollection) {
			$this->collLocalizacaoAdvogados->clearIterator();
		}
		$this->collLocalizacaoAdvogados = null;
		...
		$this->collSolicitacaos = null;
		if ($this->collTitulos instanceof PropelCollection) {
			$this->collTitulos->clearIterator();
		}
		$this->collTitulos = null;
		if ($this->collAreaAdvocacias instanceof PropelCollection) {
			$this->collAreaAdvocacias->clearIterator();
		}
		$this->collAreaAdvocacias = null;
	...
	{
		return (string) $this->exportTo(AdvogadoPeer::DEFAULT_STRING_FORMAT);
	}
