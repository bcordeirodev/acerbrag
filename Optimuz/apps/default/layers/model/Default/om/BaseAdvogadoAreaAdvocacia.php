...
/**
 * Base class that represents a row from the 'advogado_area_advocacia' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseAdvogadoAreaAdvocacia extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'AdvogadoAreaAdvocaciaPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        AdvogadoAreaAdvocaciaPeer
	 */
	 ...
	 * @return     AdvogadoAreaAdvocacia The current object (for fluent API support)
	 */
	public function setAdvogadoId($v)
	{
		...
		if ($this->advogado_id !== $v) {
			$this->advogado_id = $v;
			$this->modifiedColumns[] = AdvogadoAreaAdvocaciaPeer::ADVOGADO_ID;
		}
	...
	public function setAreaAdvocaciaId($v)
	{
		...
		if ($this->area_advocacia_id !== $v) {
			...
			$this->modifiedColumns[] = AdvogadoAreaAdvocaciaPeer::AREA_ADVOCACIA_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->advogado_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->area_advocacia_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = AdvogadoAreaAdvocaciaPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating AdvogadoAreaAdvocacia object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AdvogadoAreaAdvocaciaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AdvogadoAreaAdvocaciaQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AdvogadoAreaAdvocaciaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(AdvogadoAreaAdvocaciaPeer::ADVOGADO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ADVOGADO_ID`';
		}
		if ($this->isColumnModified(AdvogadoAreaAdvocaciaPeer::AREA_ADVOCACIA_ID)) {
			$modifiedColumns[':p' . $index++]  = '`AREA_ADVOCACIA_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `advogado_area_advocacia` (%s) VALUES (%s)',
	...
	{
		$pos = AdvogadoAreaAdvocaciaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['AdvogadoAreaAdvocacia'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AdvogadoAreaAdvocacia'][serialize($this->getPrimaryKey())] = true;
		$keys = AdvogadoAreaAdvocaciaPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getAdvogadoId(),
			$keys[1] => $this->getAreaAdvocaciaId(),
		);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setAdvogadoId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setAreaAdvocaciaId($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AdvogadoAreaAdvocaciaPeer::ADVOGADO_ID)) $criteria->add(AdvogadoAreaAdvocaciaPeer::ADVOGADO_ID, $this->advogado_id);
		if ($this->isColumnModified(AdvogadoAreaAdvocaciaPeer::AREA_ADVOCACIA_ID)) $criteria->add(AdvogadoAreaAdvocaciaPeer::AREA_ADVOCACIA_ID, $this->area_advocacia_id);
	...
	{
		$criteria = new Criteria(AdvogadoAreaAdvocaciaPeer::DATABASE_NAME);
		$criteria->add(AdvogadoAreaAdvocaciaPeer::ADVOGADO_ID, $this->advogado_id);
		$criteria->add(AdvogadoAreaAdvocaciaPeer::AREA_ADVOCACIA_ID, $this->area_advocacia_id);
	...
	{
		$pks = array();
		$pks[0] = $this->getAdvogadoId();
		$pks[1] = $this->getAreaAdvocaciaId();
	...
	{
		$this->setAdvogadoId($keys[0]);
		$this->setAreaAdvocaciaId($keys[1]);
	}
	...
	{
		return (null === $this->getAdvogadoId()) && (null === $this->getAreaAdvocaciaId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AdvogadoAreaAdvocacia (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AdvogadoAreaAdvocacia Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AdvogadoAreaAdvocaciaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AdvogadoAreaAdvocaciaPeer();
		}
		return self::$peer;
	}
	...
	public function setAdvogado(Advogado $v = null)
	{
		...
		if ($v !== null) {
			$v->addAdvogadoAreaAdvocacia($this);
		}
	...
	public function getAdvogado(PropelPDO $con = null)
	{
		if ($this->aAdvogado === null && ($this->advogado_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aAdvogado->addAdvogadoAreaAdvocacias($this);
			 */
		}
	...
	public function getAreaAdvocacia(PropelPDO $con = null)
	{
		if ($this->aAreaAdvocacia === null && ($this->area_advocacia_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aAreaAdvocacia->addAdvogadoAreaAdvocacias($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(AdvogadoAreaAdvocaciaPeer::DEFAULT_STRING_FORMAT);
	}
