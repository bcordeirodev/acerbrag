...
/**
 * Base class that represents a row from the 'advogado_cliente' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseAdvogadoCliente extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'AdvogadoClientePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        AdvogadoClientePeer
	 */
	 ...
	 * @return     AdvogadoCliente The current object (for fluent API support)
	 */
	public function setClienteId($v)
	{
		...
		if ($this->cliente_id !== $v) {
			$this->cliente_id = $v;
			$this->modifiedColumns[] = AdvogadoClientePeer::CLIENTE_ID;
		}
	...
	public function setAdvogadoId($v)
	{
		...
		if ($this->advogado_id !== $v) {
			$this->advogado_id = $v;
			$this->modifiedColumns[] = AdvogadoClientePeer::ADVOGADO_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = AdvogadoClientePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating AdvogadoCliente object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AdvogadoClientePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AdvogadoClienteQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AdvogadoClientePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(AdvogadoClientePeer::CLIENTE_ID)) {
			$modifiedColumns[':p' . $index++]  = '`CLIENTE_ID`';
		}
		if ($this->isColumnModified(AdvogadoClientePeer::ADVOGADO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ADVOGADO_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `advogado_cliente` (%s) VALUES (%s)',
	...
	{
		$pos = AdvogadoClientePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['AdvogadoCliente'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AdvogadoCliente'][serialize($this->getPrimaryKey())] = true;
		$keys = AdvogadoClientePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AdvogadoClientePeer::CLIENTE_ID)) $criteria->add(AdvogadoClientePeer::CLIENTE_ID, $this->cliente_id);
		if ($this->isColumnModified(AdvogadoClientePeer::ADVOGADO_ID)) $criteria->add(AdvogadoClientePeer::ADVOGADO_ID, $this->advogado_id);
	...
	{
		$criteria = new Criteria(AdvogadoClientePeer::DATABASE_NAME);
		$criteria->add(AdvogadoClientePeer::CLIENTE_ID, $this->cliente_id);
		$criteria->add(AdvogadoClientePeer::ADVOGADO_ID, $this->advogado_id);
	...
	{
		return (null === $this->getClienteId()) && (null === $this->getAdvogadoId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AdvogadoCliente (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AdvogadoCliente Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AdvogadoClientePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AdvogadoClientePeer();
		}
		return self::$peer;
	}
	...
	public function getAdvogado(PropelPDO $con = null)
	{
		if ($this->aAdvogado === null && ($this->advogado_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aAdvogado->addAdvogadoClientes($this);
			 */
		}
	...
	public function getCliente(PropelPDO $con = null)
	{
		if ($this->aCliente === null && ($this->cliente_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aCliente->addAdvogadoClientes($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(AdvogadoClientePeer::DEFAULT_STRING_FORMAT);
	}
