...
/**
 * Base class that represents a row from the 'advogado_inscricao_oab' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseAdvogadoInscricaoOab extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'AdvogadoInscricaoOabPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        AdvogadoInscricaoOabPeer
	 */
	 ...
	 * @return     AdvogadoInscricaoOab The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AdvogadoInscricaoOabPeer::ID;
		}
	...
	public function setAdvogadoId($v)
	{
		...
		if ($this->advogado_id !== $v) {
			$this->advogado_id = $v;
			$this->modifiedColumns[] = AdvogadoInscricaoOabPeer::ADVOGADO_ID;
		}
	...
	public function setUfId($v)
	{
		...
		if ($this->uf_id !== $v) {
			$this->uf_id = $v;
			$this->modifiedColumns[] = AdvogadoInscricaoOabPeer::UF_ID;
		}
	...
	public function setNumeroInscricao($v)
	{
		...
		if ($this->numero_inscricao !== $v) {
			...
			$this->modifiedColumns[] = AdvogadoInscricaoOabPeer::NUMERO_INSCRICAO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = AdvogadoInscricaoOabPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating AdvogadoInscricaoOab object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AdvogadoInscricaoOabPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AdvogadoInscricaoOabQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AdvogadoInscricaoOabPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(AdvogadoInscricaoOabPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(AdvogadoInscricaoOabPeer::ADVOGADO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ADVOGADO_ID`';
		}
		if ($this->isColumnModified(AdvogadoInscricaoOabPeer::UF_ID)) {
			$modifiedColumns[':p' . $index++]  = '`UF_ID`';
		}
		if ($this->isColumnModified(AdvogadoInscricaoOabPeer::NUMERO_INSCRICAO)) {
			$modifiedColumns[':p' . $index++]  = '`NUMERO_INSCRICAO`';
		}

		$sql = sprintf(
			'INSERT INTO `advogado_inscricao_oab` (%s) VALUES (%s)',
	...
	{
		$pos = AdvogadoInscricaoOabPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['AdvogadoInscricaoOab'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AdvogadoInscricaoOab'][$this->getPrimaryKey()] = true;
		$keys = AdvogadoInscricaoOabPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AdvogadoInscricaoOabPeer::ID)) $criteria->add(AdvogadoInscricaoOabPeer::ID, $this->id);
		if ($this->isColumnModified(AdvogadoInscricaoOabPeer::ADVOGADO_ID)) $criteria->add(AdvogadoInscricaoOabPeer::ADVOGADO_ID, $this->advogado_id);
		if ($this->isColumnModified(AdvogadoInscricaoOabPeer::UF_ID)) $criteria->add(AdvogadoInscricaoOabPeer::UF_ID, $this->uf_id);
		if ($this->isColumnModified(AdvogadoInscricaoOabPeer::NUMERO_INSCRICAO)) $criteria->add(AdvogadoInscricaoOabPeer::NUMERO_INSCRICAO, $this->numero_inscricao);
	...
	{
		$criteria = new Criteria(AdvogadoInscricaoOabPeer::DATABASE_NAME);
		$criteria->add(AdvogadoInscricaoOabPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AdvogadoInscricaoOab (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AdvogadoInscricaoOab Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AdvogadoInscricaoOabPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AdvogadoInscricaoOabPeer();
		}
		return self::$peer;
	}
	...
	public function setAdvogado(Advogado $v = null)
	{
		...
		if ($v !== null) {
			$v->addAdvogadoInscricaoOab($this);
		}
	...
	public function getAdvogado(PropelPDO $con = null)
	{
		if ($this->aAdvogado === null && ($this->advogado_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aAdvogado->addAdvogadoInscricaoOabs($this);
			 */
		}
	...
	public function getUf(PropelPDO $con = null)
	{
		if ($this->aUf === null && ($this->uf_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUf->addAdvogadoInscricaoOabs($this);
			 */
		}
		return $this->aUf;
	}
	...
	{
		return (string) $this->exportTo(AdvogadoInscricaoOabPeer::DEFAULT_STRING_FORMAT);
	}
