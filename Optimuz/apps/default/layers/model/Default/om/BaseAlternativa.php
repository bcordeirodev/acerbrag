...
/**
 * Base class that represents a row from the 'alternativa' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseAlternativa extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'AlternativaPeer';
	 ...
	 * @return     Alternativa The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AlternativaPeer::ID;
		}
	...
	public function setPerguntaId($v)
	{
		...
		if ($this->pergunta_id !== $v) {
			$this->pergunta_id = $v;
			$this->modifiedColumns[] = AlternativaPeer::PERGUNTA_ID;
		}
	...
	public function setTexto($v)
	{
		...
		if ($this->texto !== $v) {
			$this->texto = $v;
			$this->modifiedColumns[] = AlternativaPeer::TEXTO;
		}
	...
	public function setPosicao($v)
	{
		...
		if ($this->posicao !== $v) {
			$this->posicao = $v;
			$this->modifiedColumns[] = AlternativaPeer::POSICAO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->posicao = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = AlternativaPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Alternativa object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AlternativaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AlternativaQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AlternativaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(AlternativaPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(AlternativaPeer::PERGUNTA_ID)) {
			$modifiedColumns[':p' . $index++]  = '`PERGUNTA_ID`';
		}
		if ($this->isColumnModified(AlternativaPeer::TEXTO)) {
			$modifiedColumns[':p' . $index++]  = '`TEXTO`';
		}
		if ($this->isColumnModified(AlternativaPeer::POSICAO)) {
			$modifiedColumns[':p' . $index++]  = '`POSICAO`';
		}

		$sql = sprintf(
			'INSERT INTO `alternativa` (%s) VALUES (%s)',
	...
	{
		$pos = AlternativaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Alternativa'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Alternativa'][$this->getPrimaryKey()] = true;
		$keys = AlternativaPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getPerguntaId(),
			$keys[2] => $this->getTexto(),
			$keys[3] => $this->getPosicao(),
		);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setPosicao($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AlternativaPeer::ID)) $criteria->add(AlternativaPeer::ID, $this->id);
		if ($this->isColumnModified(AlternativaPeer::PERGUNTA_ID)) $criteria->add(AlternativaPeer::PERGUNTA_ID, $this->pergunta_id);
		if ($this->isColumnModified(AlternativaPeer::TEXTO)) $criteria->add(AlternativaPeer::TEXTO, $this->texto);
		if ($this->isColumnModified(AlternativaPeer::POSICAO)) $criteria->add(AlternativaPeer::POSICAO, $this->posicao);
	...
	{
		$criteria = new Criteria(AlternativaPeer::DATABASE_NAME);
		$criteria->add(AlternativaPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Alternativa (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Alternativa Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AlternativaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AlternativaPeer();
		}
		return self::$peer;
	}
	...
	public function getPergunta(PropelPDO $con = null)
	{
		if ($this->aPergunta === null && ($this->pergunta_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aPergunta->addAlternativas($this);
			 */
		}
	 ...
	 * If this Alternativa is new, it will return
	 ...
	 * Otherwise if this Alternativa is new, it will return
	 * an empty collection; or if this Alternativa has previously
	 * been saved, it will retrieve related Respostas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Alternativa.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	...
	{
		return (string) $this->exportTo(AlternativaPeer::DEFAULT_STRING_FORMAT);
	}
