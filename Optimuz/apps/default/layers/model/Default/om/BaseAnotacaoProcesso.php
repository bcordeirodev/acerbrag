...
/**
 * Base class that represents a row from the 'anotacao_processo' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseAnotacaoProcesso extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'AnotacaoProcessoPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        AnotacaoProcessoPeer
	 */
	 ...
	 * @return     AnotacaoProcesso The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AnotacaoProcessoPeer::ID;
		}
	...
	public function setProcessoId($v)
	{
		...
		if ($this->processo_id !== $v) {
			$this->processo_id = $v;
			$this->modifiedColumns[] = AnotacaoProcessoPeer::PROCESSO_ID;
		}
	...
	public function setTitulo($v)
	{
		...
		if ($this->titulo !== $v) {
			$this->titulo = $v;
			$this->modifiedColumns[] = AnotacaoProcessoPeer::TITULO;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = AnotacaoProcessoPeer::DESCRICAO;
		}
	...
	public function setDataCriacao($v)
	{
		...
		if ($this->data_criacao !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = AnotacaoProcessoPeer::DATA_CRIACAO;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = AnotacaoProcessoPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating AnotacaoProcesso object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AnotacaoProcessoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AnotacaoProcessoQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AnotacaoProcessoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(AnotacaoProcessoPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(AnotacaoProcessoPeer::PROCESSO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`PROCESSO_ID`';
		}
		if ($this->isColumnModified(AnotacaoProcessoPeer::TITULO)) {
			$modifiedColumns[':p' . $index++]  = '`TITULO`';
		}
		if ($this->isColumnModified(AnotacaoProcessoPeer::DESCRICAO)) {
			$modifiedColumns[':p' . $index++]  = '`DESCRICAO`';
		}
		if ($this->isColumnModified(AnotacaoProcessoPeer::DATA_CRIACAO)) {
			$modifiedColumns[':p' . $index++]  = '`DATA_CRIACAO`';
		}

		$sql = sprintf(
			'INSERT INTO `anotacao_processo` (%s) VALUES (%s)',
	...
	{
		$pos = AnotacaoProcessoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['AnotacaoProcesso'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AnotacaoProcesso'][$this->getPrimaryKey()] = true;
		$keys = AnotacaoProcessoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AnotacaoProcessoPeer::ID)) $criteria->add(AnotacaoProcessoPeer::ID, $this->id);
		if ($this->isColumnModified(AnotacaoProcessoPeer::PROCESSO_ID)) $criteria->add(AnotacaoProcessoPeer::PROCESSO_ID, $this->processo_id);
		if ($this->isColumnModified(AnotacaoProcessoPeer::TITULO)) $criteria->add(AnotacaoProcessoPeer::TITULO, $this->titulo);
		if ($this->isColumnModified(AnotacaoProcessoPeer::DESCRICAO)) $criteria->add(AnotacaoProcessoPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(AnotacaoProcessoPeer::DATA_CRIACAO)) $criteria->add(AnotacaoProcessoPeer::DATA_CRIACAO, $this->data_criacao);
	...
	{
		$criteria = new Criteria(AnotacaoProcessoPeer::DATABASE_NAME);
		$criteria->add(AnotacaoProcessoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AnotacaoProcesso (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AnotacaoProcesso Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AnotacaoProcessoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AnotacaoProcessoPeer();
		}
		return self::$peer;
	}
	...
	public function getProcesso(PropelPDO $con = null)
	{
		if ($this->aProcesso === null && ($this->processo_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aProcesso->addAnotacaoProcessos($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(AnotacaoProcessoPeer::DEFAULT_STRING_FORMAT);
	}
