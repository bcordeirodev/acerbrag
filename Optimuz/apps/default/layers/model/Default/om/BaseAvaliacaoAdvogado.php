...
/**
 * Base class that represents a row from the 'avaliacao_advogado' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseAvaliacaoAdvogado extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'AvaliacaoAdvogadoPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        AvaliacaoAdvogadoPeer
	 */
	 ...
	 * @return     AvaliacaoAdvogado The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AvaliacaoAdvogadoPeer::ID;
		}
	...
	public function setUsuarioId($v)
	{
		...
		if ($this->usuario_id !== $v) {
			$this->usuario_id = $v;
			$this->modifiedColumns[] = AvaliacaoAdvogadoPeer::USUARIO_ID;
		}
	...
	public function setAdvogadoId($v)
	{
		...
		if ($this->advogado_id !== $v) {
			$this->advogado_id = $v;
			$this->modifiedColumns[] = AvaliacaoAdvogadoPeer::ADVOGADO_ID;
		}
	...
	public function setNota($v)
	{
		...
		if ($this->nota !== $v) {
			$this->nota = $v;
			$this->modifiedColumns[] = AvaliacaoAdvogadoPeer::NOTA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = AvaliacaoAdvogadoPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating AvaliacaoAdvogado object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AvaliacaoAdvogadoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AvaliacaoAdvogadoQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AvaliacaoAdvogadoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(AvaliacaoAdvogadoPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(AvaliacaoAdvogadoPeer::USUARIO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`USUARIO_ID`';
		}
		if ($this->isColumnModified(AvaliacaoAdvogadoPeer::ADVOGADO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ADVOGADO_ID`';
		}
		if ($this->isColumnModified(AvaliacaoAdvogadoPeer::NOTA)) {
			$modifiedColumns[':p' . $index++]  = '`NOTA`';
		}

		$sql = sprintf(
			'INSERT INTO `avaliacao_advogado` (%s) VALUES (%s)',
	...
	{
		$pos = AvaliacaoAdvogadoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['AvaliacaoAdvogado'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AvaliacaoAdvogado'][$this->getPrimaryKey()] = true;
		$keys = AvaliacaoAdvogadoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AvaliacaoAdvogadoPeer::ID)) $criteria->add(AvaliacaoAdvogadoPeer::ID, $this->id);
		if ($this->isColumnModified(AvaliacaoAdvogadoPeer::USUARIO_ID)) $criteria->add(AvaliacaoAdvogadoPeer::USUARIO_ID, $this->usuario_id);
		if ($this->isColumnModified(AvaliacaoAdvogadoPeer::ADVOGADO_ID)) $criteria->add(AvaliacaoAdvogadoPeer::ADVOGADO_ID, $this->advogado_id);
		if ($this->isColumnModified(AvaliacaoAdvogadoPeer::NOTA)) $criteria->add(AvaliacaoAdvogadoPeer::NOTA, $this->nota);
	...
	{
		$criteria = new Criteria(AvaliacaoAdvogadoPeer::DATABASE_NAME);
		$criteria->add(AvaliacaoAdvogadoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AvaliacaoAdvogado (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AvaliacaoAdvogado Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AvaliacaoAdvogadoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AvaliacaoAdvogadoPeer();
		}
		return self::$peer;
	}
	...
	public function getAdvogado(PropelPDO $con = null)
	{
		if ($this->aAdvogado === null && ($this->advogado_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aAdvogado->addAvaliacaoAdvogados($this);
			 */
		}
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && ($this->usuario_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUsuario->addAvaliacaoAdvogados($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(AvaliacaoAdvogadoPeer::DEFAULT_STRING_FORMAT);
	}
