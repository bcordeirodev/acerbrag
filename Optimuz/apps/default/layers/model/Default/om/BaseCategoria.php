...
abstract class BaseCategoria extends BaseObject  implements Persistent
{
	...
	public function setNome($v)
	{
		...
		if ($this->nome !== $v) {
			$this->nome = $v;
			$this->modifiedColumns[] = CategoriaPeer::NOME;
		}
	...
	public function setPosicao($v)
	{
		...
		if ($this->posicao !== $v) {
			$this->posicao = $v;
			$this->modifiedColumns[] = CategoriaPeer::POSICAO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->posicao = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->resetModified();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(CategoriaPeer::NOME)) {
			$modifiedColumns[':p' . $index++]  = '`NOME`';
		}
		if ($this->isColumnModified(CategoriaPeer::POSICAO)) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setPosicao($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CategoriaPeer::NOME)) $criteria->add(CategoriaPeer::NOME, $this->nome);
		if ($this->isColumnModified(CategoriaPeer::POSICAO)) $criteria->add(CategoriaPeer::POSICAO, $this->posicao);
	 ...
	 * @return     PropelCollection|array Pergunta[] List of Pergunta objects
	 */
	public function getPerguntasJoinPesquisa($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PerguntaQuery::create(null, $criteria);
