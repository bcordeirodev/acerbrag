...
/**
 * Base class that represents a row from the 'curtida_forum' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseCurtidaForum extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'CurtidaForumPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CurtidaForumPeer
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CurtidaForumPeer::ID;
		}
	...
	public function setUsuarioId($v)
	{
		...
		if ($this->usuario_id !== $v) {
			$this->usuario_id = $v;
			$this->modifiedColumns[] = CurtidaForumPeer::USUARIO_ID;
		}
	...
	public function setForumId($v)
	{
		...
		if ($this->forum_id !== $v) {
			$this->forum_id = $v;
			$this->modifiedColumns[] = CurtidaForumPeer::FORUM_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = CurtidaForumPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating CurtidaForum object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CurtidaForumPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = CurtidaForumQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				CurtidaForumPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(CurtidaForumPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(CurtidaForumPeer::USUARIO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`USUARIO_ID`';
		}
		if ($this->isColumnModified(CurtidaForumPeer::FORUM_ID)) {
			$modifiedColumns[':p' . $index++]  = '`FORUM_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `curtida_forum` (%s) VALUES (%s)',
	...
	{
		$pos = CurtidaForumPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['CurtidaForum'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['CurtidaForum'][$this->getPrimaryKey()] = true;
		$keys = CurtidaForumPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CurtidaForumPeer::ID)) $criteria->add(CurtidaForumPeer::ID, $this->id);
		if ($this->isColumnModified(CurtidaForumPeer::USUARIO_ID)) $criteria->add(CurtidaForumPeer::USUARIO_ID, $this->usuario_id);
		if ($this->isColumnModified(CurtidaForumPeer::FORUM_ID)) $criteria->add(CurtidaForumPeer::FORUM_ID, $this->forum_id);
	...
	{
		$criteria = new Criteria(CurtidaForumPeer::DATABASE_NAME);
		$criteria->add(CurtidaForumPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CurtidaForum (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CurtidaForum Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CurtidaForumPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CurtidaForumPeer();
		}
		return self::$peer;
	}
	...
	public function getForum(PropelPDO $con = null)
	{
		if ($this->aForum === null && ($this->forum_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aForum->addCurtidaForums($this);
			 */
		}
		return $this->aForum;
	}
	...
	{
		return (string) $this->exportTo(CurtidaForumPeer::DEFAULT_STRING_FORMAT);
	}
