...
abstract class BaseDepartamento extends BaseObject  implements Persistent
{
	...
	public function setNome($v)
	{
		...
		if ($this->nome !== $v) {
			$this->nome = $v;
			$this->modifiedColumns[] = DepartamentoPeer::NOME;
		}
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(DepartamentoPeer::NOME)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DepartamentoPeer::NOME)) $criteria->add(DepartamentoPeer::NOME, $this->nome);
	...
	public function setDepartamentoPesquisas(PropelCollection $departamentoPesquisas, PropelPDO $con = null)
	{
		...
		foreach ($departamentoPesquisas as $departamentoPesquisa) {
			...
			if ($departamentoPesquisa->isNew()) {
				$departamentoPesquisa->setDepartamento($this);
			}
	 ...
	 * @return     PropelCollection|array DepartamentoPesquisa[] List of DepartamentoPesquisa objects
	 */
	public function getDepartamentoPesquisasJoinPesquisa($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = DepartamentoPesquisaQuery::create(null, $criteria);
	...
	public function setPesquisas(PropelCollection $pesquisas, PropelPDO $con = null)
	{
		...
		$this->pesquisasScheduledForDeletion = $this->getDepartamentoPesquisas()->diff($departamentoPesquisas);
		$this->collDepartamentoPesquisas = $departamentoPesquisas;
	 ...
	 *
	 * @param      Pesquisa $pesquisa The DepartamentoPesquisa object to relate
	 * @return     void
	 */
	...
	protected function doAddPesquisa($pesquisa)
	{
		...
		$departamentoPesquisa->setPesquisa($pesquisa);
		$this->addDepartamentoPesquisa($departamentoPesquisa);
	}
