...
/**
 * Base class that represents a row from the 'departamento_pesquisa' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseDepartamentoPesquisa extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'DepartamentoPesquisaPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        DepartamentoPesquisaPeer
	 */
	 ...
	 * @return     DepartamentoPesquisa The current object (for fluent API support)
	 */
	public function setDepartamentoId($v)
	{
		...
		if ($this->departamento_id !== $v) {
			...
			$this->modifiedColumns[] = DepartamentoPesquisaPeer::DEPARTAMENTO_ID;
		}
	...
	public function setPesquisaId($v)
	{
		...
		if ($this->pesquisa_id !== $v) {
			$this->pesquisa_id = $v;
			$this->modifiedColumns[] = DepartamentoPesquisaPeer::PESQUISA_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = DepartamentoPesquisaPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating DepartamentoPesquisa object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DepartamentoPesquisaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = DepartamentoPesquisaQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				DepartamentoPesquisaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(DepartamentoPesquisaPeer::DEPARTAMENTO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`DEPARTAMENTO_ID`';
		}
		if ($this->isColumnModified(DepartamentoPesquisaPeer::PESQUISA_ID)) {
			$modifiedColumns[':p' . $index++]  = '`PESQUISA_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `departamento_pesquisa` (%s) VALUES (%s)',
	...
	{
		$pos = DepartamentoPesquisaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['DepartamentoPesquisa'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['DepartamentoPesquisa'][serialize($this->getPrimaryKey())] = true;
		$keys = DepartamentoPesquisaPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DepartamentoPesquisaPeer::DEPARTAMENTO_ID)) $criteria->add(DepartamentoPesquisaPeer::DEPARTAMENTO_ID, $this->departamento_id);
		if ($this->isColumnModified(DepartamentoPesquisaPeer::PESQUISA_ID)) $criteria->add(DepartamentoPesquisaPeer::PESQUISA_ID, $this->pesquisa_id);
	...
	{
		$criteria = new Criteria(DepartamentoPesquisaPeer::DATABASE_NAME);
		$criteria->add(DepartamentoPesquisaPeer::DEPARTAMENTO_ID, $this->departamento_id);
		$criteria->add(DepartamentoPesquisaPeer::PESQUISA_ID, $this->pesquisa_id);
	...
	{
		return (null === $this->getDepartamentoId()) && (null === $this->getPesquisaId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of DepartamentoPesquisa (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     DepartamentoPesquisa Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     DepartamentoPesquisaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new DepartamentoPesquisaPeer();
		}
		return self::$peer;
	}
	...
	public function setDepartamento(Departamento $v = null)
	{
		...
		if ($v !== null) {
			$v->addDepartamentoPesquisa($this);
		}
	...
	public function getDepartamento(PropelPDO $con = null)
	{
		if ($this->aDepartamento === null && ($this->departamento_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aDepartamento->addDepartamentoPesquisas($this);
			 */
		}
	...
	public function getPesquisa(PropelPDO $con = null)
	{
		if ($this->aPesquisa === null && ($this->pesquisa_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aPesquisa->addDepartamentoPesquisas($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(DepartamentoPesquisaPeer::DEFAULT_STRING_FORMAT);
	}
