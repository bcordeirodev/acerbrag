 ...
 * @method     DepartamentoQuery orderByNome($order = Criteria::ASC) Order by the nome column
 *
 * @method     DepartamentoQuery groupById() Group by the id column
 * @method     DepartamentoQuery groupByNome() Group by the nome column
 *
 ...
 *
 * @method     DepartamentoQuery leftJoinDepartamentoPesquisa($relationAlias = null) Adds a LEFT JOIN clause to the query using the DepartamentoPesquisa relation
 * @method     DepartamentoQuery rightJoinDepartamentoPesquisa($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DepartamentoPesquisa relation
 * @method     DepartamentoQuery innerJoinDepartamentoPesquisa($relationAlias = null) Adds a INNER JOIN clause to the query using the DepartamentoPesquisa relation
 *
 * @method     DepartamentoQuery leftJoinUsuario($relationAlias = null) Adds a LEFT JOIN clause to the query using the Usuario relation
 * @method     DepartamentoQuery rightJoinUsuario($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Usuario relation
 * @method     DepartamentoQuery innerJoinUsuario($relationAlias = null) Adds a INNER JOIN clause to the query using the Usuario relation
 *
 ...
 * @method     Departamento findOneByNome(string $nome) Return the first Departamento filtered by the nome column
 *
 * @method     array findById(int $id) Return Departamento objects filtered by the id column
 * @method     array findByNome(string $nome) Return Departamento objects filtered by the nome column
 *
...
abstract class BaseDepartamentoQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'Default', $modelName = 'Departamento', $modelAlias = null)
	{
	 ...
	 *
	 * @return    Departamento|array|mixed the result, formatted by the current formatter
	 */
	...
	{
		$sql = 'SELECT `ID`, `NOME` FROM `departamento` WHERE `ID` = :p0';
		try {
		...
		if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$obj->hydrate($row);
			DepartamentoPeer::addInstanceToPool($obj, (string) $row[0]);
		}
		$stmt->closeCursor();
	...
	public function filterByNome($nome = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(DepartamentoPeer::NOME, $nome, $comparison);
	}
	...
	public function filterByDepartamentoPesquisa($departamentoPesquisa, $comparison = null)
	{
		if ($departamentoPesquisa instanceof DepartamentoPesquisa) {
			return $this
				->addUsingAlias(DepartamentoPeer::ID, $departamentoPesquisa->getDepartamentoId(), $comparison);
	...
	public function filterByUsuario($usuario, $comparison = null)
	{
		if ($usuario instanceof Usuario) {
			return $this
				->addUsingAlias(DepartamentoPeer::ID, $usuario->getDepartamentoId(), $comparison);
