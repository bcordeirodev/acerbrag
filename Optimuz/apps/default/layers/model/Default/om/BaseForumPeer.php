...
abstract class BaseForumPeer {
	...
	const OM_CLASS = 'Forum';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'Default.Forum';
	...
	const USUARIO_ID = 'forum.USUARIO_ID';

	/** the column name for the TITULO field */
	const TITULO = 'forum.TITULO';

	/** the column name for the TOPICO field */
	const TOPICO = 'forum.TOPICO';

	/** the column name for the DATA_CRICACAO field */
	const DATA_CRICACAO = 'forum.DATA_CRICACAO';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UsuarioId', 'Titulo', 'Topico', 'DataCricacao', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'usuarioId', 'titulo', 'topico', 'dataCricacao', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USUARIO_ID, self::TITULO, self::TOPICO, self::DATA_CRICACAO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USUARIO_ID', 'TITULO', 'TOPICO', 'DATA_CRICACAO', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'usuario_id', 'titulo', 'topico', 'data_cricacao', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UsuarioId' => 1, 'Titulo' => 2, 'Topico' => 3, 'DataCricacao' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'usuarioId' => 1, 'titulo' => 2, 'topico' => 3, 'dataCricacao' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USUARIO_ID => 1, self::TITULO => 2, self::TOPICO => 3, self::DATA_CRICACAO => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USUARIO_ID' => 1, 'TITULO' => 2, 'TOPICO' => 3, 'DATA_CRICACAO' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'usuario_id' => 1, 'titulo' => 2, 'topico' => 3, 'data_cricacao' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ForumPeer::USUARIO_ID);
			$criteria->addSelectColumn(ForumPeer::TITULO);
			$criteria->addSelectColumn(ForumPeer::TOPICO);
			$criteria->addSelectColumn(ForumPeer::DATA_CRICACAO);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.USUARIO_ID');
			$criteria->addSelectColumn($alias . '.TITULO');
			$criteria->addSelectColumn($alias . '.TOPICO');
			$criteria->addSelectColumn($alias . '.DATA_CRICACAO');
		}
	}
	...
	{
		return $withPrefix ? ForumPeer::CLASS_DEFAULT : ForumPeer::OM_CLASS;
	}
