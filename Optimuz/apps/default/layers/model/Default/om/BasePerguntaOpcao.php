...
/**
 * Base class that represents a row from the 'pergunta_opcao' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BasePerguntaOpcao extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'PerguntaOpcaoPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PerguntaOpcaoPeer
	 */
	 ...
	 * @return     PerguntaOpcao The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PerguntaOpcaoPeer::ID;
		}
	...
	public function setPerguntaId($v)
	{
		...
		if ($this->pergunta_id !== $v) {
			$this->pergunta_id = $v;
			$this->modifiedColumns[] = PerguntaOpcaoPeer::PERGUNTA_ID;
		}
	...
	public function setTexto($v)
	{
		...
		if ($this->texto !== $v) {
			$this->texto = $v;
			$this->modifiedColumns[] = PerguntaOpcaoPeer::TEXTO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = PerguntaOpcaoPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating PerguntaOpcao object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PerguntaOpcaoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = PerguntaOpcaoQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				PerguntaOpcaoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(PerguntaOpcaoPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(PerguntaOpcaoPeer::PERGUNTA_ID)) {
			$modifiedColumns[':p' . $index++]  = '`PERGUNTA_ID`';
		}
		if ($this->isColumnModified(PerguntaOpcaoPeer::TEXTO)) {
			$modifiedColumns[':p' . $index++]  = '`TEXTO`';
		}

		$sql = sprintf(
			'INSERT INTO `pergunta_opcao` (%s) VALUES (%s)',
	...
	{
		$pos = PerguntaOpcaoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['PerguntaOpcao'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['PerguntaOpcao'][$this->getPrimaryKey()] = true;
		$keys = PerguntaOpcaoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PerguntaOpcaoPeer::ID)) $criteria->add(PerguntaOpcaoPeer::ID, $this->id);
		if ($this->isColumnModified(PerguntaOpcaoPeer::PERGUNTA_ID)) $criteria->add(PerguntaOpcaoPeer::PERGUNTA_ID, $this->pergunta_id);
		if ($this->isColumnModified(PerguntaOpcaoPeer::TEXTO)) $criteria->add(PerguntaOpcaoPeer::TEXTO, $this->texto);
	...
	{
		$criteria = new Criteria(PerguntaOpcaoPeer::DATABASE_NAME);
		$criteria->add(PerguntaOpcaoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PerguntaOpcao (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PerguntaOpcao Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PerguntaOpcaoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PerguntaOpcaoPeer();
		}
		return self::$peer;
	}
	...
	public function getPergunta(PropelPDO $con = null)
	{
		if ($this->aPergunta === null && ($this->pergunta_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aPergunta->addPerguntaOpcaos($this);
			 */
		}
	 ...
	 * If this PerguntaOpcao is new, it will return
	...
	public function setRespostas(PropelCollection $respostas, PropelPDO $con = null)
	{
		...
		foreach ($respostas as $resposta) {
			...
			if ($resposta->isNew()) {
				$resposta->setPerguntaOpcao($this);
			}
	 ...
	 * Otherwise if this PerguntaOpcao is new, it will return
	 * an empty collection; or if this PerguntaOpcao has previously
	 * been saved, it will retrieve related Respostas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in PerguntaOpcao.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	...
	{
		return (string) $this->exportTo(PerguntaOpcaoPeer::DEFAULT_STRING_FORMAT);
	}
