...
abstract class BasePermissaoPeer {
	...
	const CLASS_DEFAULT = 'Default.Permissao';
	...
	const NOME = 'permissao.NOME';

	/** the column name for the SLUG field */
	const SLUG = 'permissao.SLUG';
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(PermissaoPeer::ID);
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(PermissaoPeer::ID) && $criteria->keyContainsValue(PermissaoPeer::ID) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PermissaoPeer::ID);
			$value = $criteria->remove(PermissaoPeer::ID);
			if ($value) {
				$selectCriteria->add(PermissaoPeer::ID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PermissaoPeer::ID, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				PermissaoPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = PermissaoPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(PermissaoPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PermissaoPeer::DATABASE_NAME);
			$criteria->add(PermissaoPeer::ID, $pks, Criteria::IN);
			$objs = PermissaoPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
