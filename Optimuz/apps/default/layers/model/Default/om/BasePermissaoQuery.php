 ...
 * 
 *
 * @method     PermissaoQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 *
 * @method     PermissaoQuery leftJoinPerfilPermissao($relationAlias = null) Adds a LEFT JOIN clause to the query using the PerfilPermissao relation
 * @method     PermissaoQuery rightJoinPerfilPermissao($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PerfilPermissao relation
 * @method     PermissaoQuery innerJoinPerfilPermissao($relationAlias = null) Adds a INNER JOIN clause to the query using the PerfilPermissao relation
 *
 ...
 *
 * @method     Permissao findOneById(int $id) Return the first Permissao filtered by the id column
...
abstract class BasePermissaoQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'Default', $modelName = 'Permissao', $modelAlias = null)
	{
	...
	public function findPk($key, $con = null)
	{
		...
		if ((null !== ($obj = PermissaoPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
	...
	protected function findPkSimple($key, $con)
	{
		...
		if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$obj = new Permissao();
			$obj->hydrate($row);
			PermissaoPeer::addInstanceToPool($obj, (string) $row[0]);
		}
		$stmt->closeCursor();
	...
	{
		return $this->addUsingAlias(PermissaoPeer::ID, $key, Criteria::EQUAL);
	}
	...
	{
		return $this->addUsingAlias(PermissaoPeer::ID, $keys, Criteria::IN);
	}
	...
	public function filterById($id = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(PermissaoPeer::ID, $id, $comparison);
	}
	...
	public function filterByNome($nome = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(PermissaoPeer::NOME, $nome, $comparison);
	}
	...
	public function filterBySlug($slug = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(PermissaoPeer::SLUG, $slug, $comparison);
	}
	...
	public function filterByPerfilPermissao($perfilPermissao, $comparison = null)
	{
		if ($perfilPermissao instanceof PerfilPermissao) {
			return $this
				->addUsingAlias(PermissaoPeer::ID, $perfilPermissao->getPermissaoId(), $comparison);
	 ...
	 *
	 * @param     Perfil $perfil the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    PermissaoQuery The current query, for fluid interface
	 */
	public function filterByPerfil($perfil, $comparison = Criteria::EQUAL)
	{
		return $this
			->usePerfilPermissaoQuery()
			->filterByPerfil($perfil, $comparison)
			->endUse();
	}
	...
	{
		if ($permissao) {
			$this->addUsingAlias(PermissaoPeer::ID, $permissao->getId(), Criteria::NOT_EQUAL);
		}
