...
/**
 * Base class that represents a row from the 'pesquisa_usuario' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BasePesquisaUsuario extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'PesquisaUsuarioPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PesquisaUsuarioPeer
	 */
	 ...
	 * @return     PesquisaUsuario The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PesquisaUsuarioPeer::ID;
		}
	...
	public function setUsuarioId($v)
	{
		...
		if ($this->usuario_id !== $v) {
			$this->usuario_id = $v;
			$this->modifiedColumns[] = PesquisaUsuarioPeer::USUARIO_ID;
		}
	...
	public function setPesquisaId($v)
	{
		...
		if ($this->pesquisa_id !== $v) {
			$this->pesquisa_id = $v;
			$this->modifiedColumns[] = PesquisaUsuarioPeer::PESQUISA_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = PesquisaUsuarioPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating PesquisaUsuario object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PesquisaUsuarioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = PesquisaUsuarioQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				PesquisaUsuarioPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(PesquisaUsuarioPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(PesquisaUsuarioPeer::USUARIO_ID)) {
			$modifiedColumns[':p' . $index++]  = '`USUARIO_ID`';
		}
		if ($this->isColumnModified(PesquisaUsuarioPeer::PESQUISA_ID)) {
			$modifiedColumns[':p' . $index++]  = '`PESQUISA_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `pesquisa_usuario` (%s) VALUES (%s)',
	...
	{
		$pos = PesquisaUsuarioPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['PesquisaUsuario'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['PesquisaUsuario'][$this->getPrimaryKey()] = true;
		$keys = PesquisaUsuarioPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PesquisaUsuarioPeer::ID)) $criteria->add(PesquisaUsuarioPeer::ID, $this->id);
		if ($this->isColumnModified(PesquisaUsuarioPeer::USUARIO_ID)) $criteria->add(PesquisaUsuarioPeer::USUARIO_ID, $this->usuario_id);
		if ($this->isColumnModified(PesquisaUsuarioPeer::PESQUISA_ID)) $criteria->add(PesquisaUsuarioPeer::PESQUISA_ID, $this->pesquisa_id);
	...
	{
		$criteria = new Criteria(PesquisaUsuarioPeer::DATABASE_NAME);
		$criteria->add(PesquisaUsuarioPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PesquisaUsuario (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PesquisaUsuario Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PesquisaUsuarioPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PesquisaUsuarioPeer();
		}
		return self::$peer;
	}
	...
	public function getPesquisa(PropelPDO $con = null)
	{
		if ($this->aPesquisa === null && ($this->pesquisa_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aPesquisa->addPesquisaUsuarios($this);
			 */
		}
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && ($this->usuario_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUsuario->addPesquisaUsuarios($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(PesquisaUsuarioPeer::DEFAULT_STRING_FORMAT);
	}
