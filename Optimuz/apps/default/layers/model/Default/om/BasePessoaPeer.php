...
abstract class BasePessoaPeer {
	...
	const CLASS_DEFAULT = 'Default.Pessoa';
	...
	const ENDERECO_ID = 'pessoa.ENDERECO_ID';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'EnderecoId', 'Ativo', 'Nome', 'Cpf', 'Celular', 'Telefone', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'enderecoId', 'ativo', 'nome', 'cpf', 'celular', 'telefone', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ENDERECO_ID, self::ATIVO, self::NOME, self::CPF, self::CELULAR, self::TELEFONE, self::EMAIL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ENDERECO_ID', 'ATIVO', 'NOME', 'CPF', 'CELULAR', 'TELEFONE', 'EMAIL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'endereco_id', 'ativo', 'nome', 'cpf', 'celular', 'telefone', 'email', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'EnderecoId' => 1, 'Ativo' => 2, 'Nome' => 3, 'Cpf' => 4, 'Celular' => 5, 'Telefone' => 6, 'Email' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'enderecoId' => 1, 'ativo' => 2, 'nome' => 3, 'cpf' => 4, 'celular' => 5, 'telefone' => 6, 'email' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ENDERECO_ID => 1, self::ATIVO => 2, self::NOME => 3, self::CPF => 4, self::CELULAR => 5, self::TELEFONE => 6, self::EMAIL => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ENDERECO_ID' => 1, 'ATIVO' => 2, 'NOME' => 3, 'CPF' => 4, 'CELULAR' => 5, 'TELEFONE' => 6, 'EMAIL' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'endereco_id' => 1, 'ativo' => 2, 'nome' => 3, 'cpf' => 4, 'celular' => 5, 'telefone' => 6, 'email' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(PessoaPeer::ID);
			$criteria->addSelectColumn(PessoaPeer::ENDERECO_ID);
			$criteria->addSelectColumn(PessoaPeer::ATIVO);
			$criteria->addSelectColumn(PessoaPeer::NOME);
			$criteria->addSelectColumn(PessoaPeer::CPF);
			$criteria->addSelectColumn(PessoaPeer::CELULAR);
			$criteria->addSelectColumn(PessoaPeer::TELEFONE);
			$criteria->addSelectColumn(PessoaPeer::EMAIL);
		} else {
	 ...
	 *
	 * @param      Pessoa $value A Pessoa object.
	...
	public static function doCountJoinEndereco(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(PessoaPeer::ENDERECO_ID, EnderecoPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Pessoa objects pre-filled with their Endereco objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinEndereco(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Pessoa) to $obj2 (Endereco)
				$obj2->addPessoa($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Pessoa) to the collection in $obj2 (Endereco)
				$obj2->addPessoa($obj1);
	...
	{
		return $withPrefix ? PessoaPeer::CLASS_DEFAULT : PessoaPeer::OM_CLASS;
	}
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(PessoaPeer::ID) && $criteria->keyContainsValue(PessoaPeer::ID) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PessoaPeer::ID);
			$value = $criteria->remove(PessoaPeer::ID);
			if ($value) {
				$selectCriteria->add(PessoaPeer::ID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PessoaPeer::ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PessoaPeer::DATABASE_NAME);
			$criteria->add(PessoaPeer::ID, $pks, Criteria::IN);
