...
abstract class BasePodcastPeer {
	...
	const CLASS_DEFAULT = 'Default.Podcast';
	...
	const INSTITUICAO_ID = 'podcast.INSTITUICAO_ID';

	/** the column name for the CRIADOR_ID field */
	const CRIADOR_ID = 'podcast.CRIADOR_ID';

	/** the column name for the TITULO field */
	const TITULO = 'podcast.TITULO';

	/** the column name for the DESCRICAO field */
	const DESCRICAO = 'podcast.DESCRICAO';

	/** the column name for the DATA_CADASTRO field */
	const DATA_CADASTRO = 'podcast.DATA_CADASTRO';

	/** the column name for the ATIVO field */
	const ATIVO = 'podcast.ATIVO';

	/** The default string format for model objects of the related table **/
	const DEFAULT_STRING_FORMAT = 'YAML';

	/**
	 * An identiy map to hold any loaded instances of Podcast objects.
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'InstituicaoId', 'CriadorId', 'Titulo', 'Descricao', 'DataCadastro', 'Ativo', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'instituicaoId', 'criadorId', 'titulo', 'descricao', 'dataCadastro', 'ativo', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::INSTITUICAO_ID, self::CRIADOR_ID, self::TITULO, self::DESCRICAO, self::DATA_CADASTRO, self::ATIVO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'INSTITUICAO_ID', 'CRIADOR_ID', 'TITULO', 'DESCRICAO', 'DATA_CADASTRO', 'ATIVO', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'instituicao_id', 'criador_id', 'titulo', 'descricao', 'data_cadastro', 'ativo', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'InstituicaoId' => 1, 'CriadorId' => 2, 'Titulo' => 3, 'Descricao' => 4, 'DataCadastro' => 5, 'Ativo' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'instituicaoId' => 1, 'criadorId' => 2, 'titulo' => 3, 'descricao' => 4, 'dataCadastro' => 5, 'ativo' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::INSTITUICAO_ID => 1, self::CRIADOR_ID => 2, self::TITULO => 3, self::DESCRICAO => 4, self::DATA_CADASTRO => 5, self::ATIVO => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'INSTITUICAO_ID' => 1, 'CRIADOR_ID' => 2, 'TITULO' => 3, 'DESCRICAO' => 4, 'DATA_CADASTRO' => 5, 'ATIVO' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'instituicao_id' => 1, 'criador_id' => 2, 'titulo' => 3, 'descricao' => 4, 'data_cadastro' => 5, 'ativo' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PodcastPeer::INSTITUICAO_ID);
			$criteria->addSelectColumn(PodcastPeer::CRIADOR_ID);
			$criteria->addSelectColumn(PodcastPeer::TITULO);
			$criteria->addSelectColumn(PodcastPeer::DESCRICAO);
			$criteria->addSelectColumn(PodcastPeer::DATA_CADASTRO);
			$criteria->addSelectColumn(PodcastPeer::ATIVO);
		} else {
	 ...
	 *
	 * @param      Podcast $value A Podcast object.
	...
	public static function doCountJoinUsuario(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(PodcastPeer::CRIADOR_ID, UsuarioPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Podcast objects pre-filled with their Usuario objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Podcast) to $obj2 (Usuario)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Podcast) to the collection in $obj2 (Usuario)
				$obj2->addPodcast($obj1);
	...
	{
		return $withPrefix ? PodcastPeer::CLASS_DEFAULT : PodcastPeer::OM_CLASS;
	}
