...
/**
 * Base class that represents a row from the 'profissao' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseProfissao extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ProfissaoPeer';
	 ...
	 * @return     Profissao The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ProfissaoPeer::ID;
		}
	...
	public function setNome($v)
	{
		...
		if ($this->nome !== $v) {
			$this->nome = $v;
			$this->modifiedColumns[] = ProfissaoPeer::NOME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ProfissaoPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Profissao object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProfissaoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ProfissaoQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ProfissaoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(ProfissaoPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(ProfissaoPeer::NOME)) {
			$modifiedColumns[':p' . $index++]  = '`NOME`';
		}

		$sql = sprintf(
			'INSERT INTO `profissao` (%s) VALUES (%s)',
	...
	{
		$pos = ProfissaoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Profissao'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Profissao'][$this->getPrimaryKey()] = true;
		$keys = ProfissaoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getNome(),
		);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProfissaoPeer::ID)) $criteria->add(ProfissaoPeer::ID, $this->id);
		if ($this->isColumnModified(ProfissaoPeer::NOME)) $criteria->add(ProfissaoPeer::NOME, $this->nome);
	...
	{
		$criteria = new Criteria(ProfissaoPeer::DATABASE_NAME);
		$criteria->add(ProfissaoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Profissao (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Profissao Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProfissaoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ProfissaoPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this Profissao is new, it will return
	 ...
	 * Otherwise if this Profissao is new, it will return
	 * an empty collection; or if this Profissao has previously
	 * been saved, it will retrieve related Pesquisas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Profissao.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array Pesquisa[] List of Pesquisa objects
	 */
	public function getPesquisasJoinCidade($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PesquisaQuery::create(null, $criteria);
		$query->joinWith('Cidade', $join_behavior);

		return $this->getPesquisas($query, $con);
	}
	 ...
	 * @return     PropelCollection|array Pesquisa[] List of Pesquisa objects
	 */
	public function getPesquisasJoinUf($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PesquisaQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array Pesquisa[] List of Pesquisa objects
	 */
	public function getPesquisasJoinUsuario($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PesquisaQuery::create(null, $criteria);
	...
	{
		return (string) $this->exportTo(ProfissaoPeer::DEFAULT_STRING_FORMAT);
	}
