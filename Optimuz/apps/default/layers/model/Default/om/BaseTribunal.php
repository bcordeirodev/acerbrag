...
/**
 * Base class that represents a row from the 'tribunal' table.
 *
 * 
 *
 * @package    propel.generator.Default.om
 */
abstract class BaseTribunal extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'TribunalPeer';
	 ...
	 * @return     Tribunal The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TribunalPeer::ID;
		}
	...
	public function setNome($v)
	{
		...
		if ($this->nome !== $v) {
			$this->nome = $v;
			$this->modifiedColumns[] = TribunalPeer::NOME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = TribunalPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Tribunal object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TribunalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = TribunalQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				TribunalPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(TribunalPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(TribunalPeer::NOME)) {
			$modifiedColumns[':p' . $index++]  = '`NOME`';
		}

		$sql = sprintf(
			'INSERT INTO `tribunal` (%s) VALUES (%s)',
	...
	{
		$pos = TribunalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Tribunal'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Tribunal'][$this->getPrimaryKey()] = true;
		$keys = TribunalPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getNome(),
		);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TribunalPeer::ID)) $criteria->add(TribunalPeer::ID, $this->id);
		if ($this->isColumnModified(TribunalPeer::NOME)) $criteria->add(TribunalPeer::NOME, $this->nome);
	...
	{
		$criteria = new Criteria(TribunalPeer::DATABASE_NAME);
		$criteria->add(TribunalPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tribunal (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tribunal Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * If this Tribunal is new, it will return
	 ...
	 * Otherwise if this Tribunal is new, it will return
	 * an empty collection; or if this Tribunal has previously
	 * been saved, it will retrieve related Processos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tribunal.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	...
	{
		return (string) $this->exportTo(TribunalPeer::DEFAULT_STRING_FORMAT);
	}
