...
abstract class BaseVideoPeer {
	...
	const CLASS_DEFAULT = 'Default.Video';
	...
	const INSTITUICAO_ID = 'video.INSTITUICAO_ID';
	...
	const DATA_CADASTRO = 'video.DATA_CADASTRO';

	/** the column name for the ATIVO field */
	const ATIVO = 'video.ATIVO';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'InstituicaoId', 'Titulo', 'Descricao', 'Url', 'DataCadastro', 'Ativo', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'instituicaoId', 'titulo', 'descricao', 'url', 'dataCadastro', 'ativo', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::INSTITUICAO_ID, self::TITULO, self::DESCRICAO, self::URL, self::DATA_CADASTRO, self::ATIVO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'INSTITUICAO_ID', 'TITULO', 'DESCRICAO', 'URL', 'DATA_CADASTRO', 'ATIVO', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'instituicao_id', 'titulo', 'descricao', 'url', 'data_cadastro', 'ativo', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'InstituicaoId' => 1, 'Titulo' => 2, 'Descricao' => 3, 'Url' => 4, 'DataCadastro' => 5, 'Ativo' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'instituicaoId' => 1, 'titulo' => 2, 'descricao' => 3, 'url' => 4, 'dataCadastro' => 5, 'ativo' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::INSTITUICAO_ID => 1, self::TITULO => 2, self::DESCRICAO => 3, self::URL => 4, self::DATA_CADASTRO => 5, self::ATIVO => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'INSTITUICAO_ID' => 1, 'TITULO' => 2, 'DESCRICAO' => 3, 'URL' => 4, 'DATA_CADASTRO' => 5, 'ATIVO' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'instituicao_id' => 1, 'titulo' => 2, 'descricao' => 3, 'url' => 4, 'data_cadastro' => 5, 'ativo' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(VideoPeer::INSTITUICAO_ID);
			$criteria->addSelectColumn(VideoPeer::TITULO);
			$criteria->addSelectColumn(VideoPeer::DESCRICAO);
			$criteria->addSelectColumn(VideoPeer::URL);
			$criteria->addSelectColumn(VideoPeer::DATA_CADASTRO);
			$criteria->addSelectColumn(VideoPeer::ATIVO);
		} else {
