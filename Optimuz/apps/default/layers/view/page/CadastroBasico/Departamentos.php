<div class="page-title">
	...
	<h3><span class="semi-bold">Departamentos</span></h3>
</div>
<div class="row">
	<div class="col-md-6">
		<form action="~/cadastro-basico/salvar" class="js-form" method="post" object-type="FormComponent">
			<div class="grid simple">
				<div class="grid-title no-border">
					<h4>Nuevo <span class="semi-bold">Departamento</span></h4>
					<div class="tools">
				...
				<div class="grid-body no-border">
					...
					<div class="form-actions">
						<div class="pull-right">
							<input type="hidden" name="cadastro" value="departamentos" required>
	...
	<div class="col-md-6">
		<div class="grid simple">
			<div class="grid-title no-border">
				<h4>Departamentos <span class="semi-bold">Cadastrados</span></h4>
				<div class="tools">
					<a href="javascript:;" class="collapse"></a>
				</div>
			</div>
			<div class="grid-body no-border">
				<table class="table table-hover js-dynamic-table" data-source="listar/departamentos" data-sort="false">
					<thead>
						<tr>
							<th>Nombre</th>
