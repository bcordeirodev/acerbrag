<div class="page-title row">
	...
	<div class="col-md-4 text-right no-padding">
		...
		<a href="~/premio/novo" id="js-new-link" class="m-l-10 btn btn-success" object-type="HtmlLink"><i class="mdi mdi-plus text-white"></i> Nuevo</a>
...
<form action="~/premio/atualizar" class="js-form" method="post" object-type="FormComponent">
	<div class="row">
		<div class="col-md-12">
