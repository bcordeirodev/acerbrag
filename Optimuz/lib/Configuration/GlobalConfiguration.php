<?php
/**
 * This file defines a good way to read and edit the framework's (global)
 * configuration.
 * @version 0.1
...
/**
 * This class manages the global configuration setted in the framework's
 * configuration file. Configurations file can be a XML or a Properties text
 * file.
 ...
 * @uses Lang
 */
final class GlobalConfiguration extends Configuration
{
	/**
	 * Configuration ID.
	 * @var string
	 ...
	 * that will be loaded. Default is GlobalConfiguration::TEXT_CONFIG.
	 * @static
	 */
	public static function load($configType = self::TEXT_CONFIG)
	{
		self::$configId = get_class();
		$path = Enviroment::getPath('config') . 'settings' . Enviroment::DIR_SEP . "global.{$configType}";
	 ...
	 * @static
	 * @see GlobalConfiguration::get()
	 * @see GlobalConfiguration::exists()
	 * @see GlobalConfiguration::hasValue()
	 */
	 ...
	 * @static
	 * @see GlobalConfiguration::set()
	 * @see GlobalConfiguration::exists()
	 * @see GlobalConfiguration::hasValue()
	 */
	public static function get($name)
	{
		return parent::internalGet($name, self::$configId);
	}
	 ...
	 * @static
	 * @see Configuration::$attributes
	 * @see GlobalConfiguration::getSettings()
	 */
