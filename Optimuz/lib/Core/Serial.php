...
class Serial
{
	...
	/**
	 * Number of blocks that the final number can have.
	 * @var int
	 */
	private $blocks		= null;
	 ...
	 * @param int $length (optimal) Number of elements in each block of the
	 * serial. Must be between 1 and 10. Any other value will throw an
	 * exception. Default is 10.
	 * @param int $blocks (optimal) Number of blocks the serial number can have.
	 * Default is 4.
	 */
	public function __construct($length = 10, $blocks = 4)
	{
		$this->blocks = $blocks;
	...
	/**
	 * Factory method that creates a new instance of the class to generate and
	 ...
	 * @static
	 */
	public static function create($length = 10, $blocks = 4)
	{
		return new self($length, $blocks);
	}
