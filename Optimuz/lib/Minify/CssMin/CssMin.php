...
/**
 * Class used to minify CSS files.
 * 
 * <code>
 * include("cssmin.php");
 * file_put_contents("path/to/target.css", cssmin::minify(file_get_contents("path/to/source.css")));
...
class CssMin
{
	...
	/**
	 * Return an array structure of a stylesheet definitions.
	 *
	 * <code>
	...
	/**
	 * Return an array structure created by {@link cssmin::toArray()} to a string.
	 *
	 * <code>
